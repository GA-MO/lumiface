  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 p-6 text-center">
      ...
      <button
        type="button"
        onClick={onStart}
        className="rounded-lg bg-fd-primary px-5 py-2.5 font-medium text-fd-primary-foreground shadow-sm hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fd-primary"
      >
...
function LineIcon({ kind }: { kind: DemoLine["kind"] }) {
  ...
  if (kind === "step") return <ChevronRight className="h-3.5 w-3.5 text-fd-primary" />;
...
export function LiveDemo() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="relative mx-auto w-full max-w-[300px] overflow-hidden rounded-[2.2rem] border-[6px] border-[#1a222d] bg-[#1a222d] shadow-[0_40px_70px_-30px_rgba(15,23,42,0.6)] ring-1 ring-black/10 sm:max-w-none sm:rounded-2xl sm:border-0">
