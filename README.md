...
The live demo on the docs home runs `liveness` against a stand-in server that judges nothing; the example app and the React demo run both flows against a real server.
