...
class AntiSpoof:
    def __init__(self) -> None:
        ...
        for name, scale in MODELS:
            ...
            self.sessions.append((name, scale, ort.InferenceSession(str(path), sess_options=session_options(),
        ...
        if s.cvpr_enabled:
            ...
            self.cvpr = ort.InferenceSession(str(path), sess_options=session_options(), providers=["CPUExecutionProvider"])
...
_antispoof: AntiSpoof | None = None
