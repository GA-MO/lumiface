...
from ..policy import PRESET_OVERRIDES, PRESET_SUMMARY, PRESETS, Policy, deep_merge, policy_schema, preset_policy, resolve_policy
...
def update_policy(body: PolicyUpdate, project: Project = Depends(current_project),
    ...
    if body.overrides is None:
        ...
        overrides = deep_merge(current, body.overrides) if body.merge else body.overrides
    try:
